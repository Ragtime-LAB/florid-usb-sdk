...
def command_thread_func():
    ...
    print("robot_sync on|off         播放时真机同步末端线性 MIT_PD+gravity 跟踪")
    print("robot_goto NAME [T]       真机通过末端线性 MIT_PD+gravity 轨迹移动到某个示教点")
    print("robot_goto_sim [T]        真机通过末端线性 MIT_PD+gravity 轨迹移动到当前仿真姿态")
    print("help                      显示命令")
    print("quit                      退出")
    print("==============================================\n")
